...
export default function SozlukYonetimi() {
  ...
  return (
    <section className="sozluk-yonetimi">
      ...
      {eksikSayisi > 0 && <div className="sozluk-mesaj hatali">English seçeneği açık; ancak {eksikSayisi} çeviri eksik. Müşteriye boş metin gösterilmemesi için alanları tamamlayıp sözlüğü yayınlayın.</div>}
