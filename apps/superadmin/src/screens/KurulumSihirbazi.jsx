...
import { erisimTokeniOlustur, kurulumTamamla, personelPanelineGit, slugKontrol } from "../lib/superApi";
...
export default function KurulumSihirbazi({ kapat, tamamlandi }) {
  ...
  const personelEkle = (rol = "mutfak") => {
    const yeni = { ad: "", soyad: "", rol, email: "", sifre: rastgeleSifre() };
