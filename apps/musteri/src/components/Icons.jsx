...
export const IconGlobe = (p) => (
  <svg viewBox="0 0 24 24" {...s} {...p}><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3c3 3 4 6 4 9s-1 6-4 9M12 3c-3 3-4 6-4 9s1 6 4 9" /></svg>
);
...
/* Ürün detayında alerjen uyarısı için */
export const IconWarning = (p) => (
  <svg viewBox="0 0 24 24" {...s} {...p}><path d="M12 3 2 20h20L12 3z" /><path d="M12 10v4M12 17v.01" /></svg>
);
