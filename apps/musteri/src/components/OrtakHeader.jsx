            ...
            <div className="bildirim-katman">
              ...
              >
                ...
                {duyurular.length ? <div>{duyurular.slice(0, 6).map((duyuru) => {
                  ...
                  return <button className={okundu ? "okundu" : "okunmadi"} key={duyuru.id} onClick={() => duyuruyaGit(duyuru)}><i>•</i><span><b>{yerelAlan(duyuru, "baslik", duyuru.baslik)}</b><small>{yerelAlan(duyuru, "mesaj", duyuru.mesaj)}</small></span><em>›</em></button>;
