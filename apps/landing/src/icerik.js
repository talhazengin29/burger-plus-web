...
export function whatsappButonuHtml() {
  ...
  return `
    <a class="whatsapp-buton" href="${adres}" target="_blank" rel="noopener noreferrer" aria-label="${kacis(WHATSAPP.etiket)}">
      <svg class="whatsapp-ikon" aria-hidden="true" viewBox="0 0 24 24" fill="none">
        <path d="M20 11.6a8 8 0 0 1-11.75 7.06L4 20l1.35-4.12A8 8 0 1 1 20 11.6Z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M8.4 7.75c.55 3.73 2.62 5.8 6.35 6.35l1.05-1.08-2.2-1.4-.9.77a7.02 7.02 0 0 1-2.68-2.68l.78-.9-1.4-2.2-1 .99v.15Z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
